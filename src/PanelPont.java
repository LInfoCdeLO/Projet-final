...
public class PanelPont extends JPanel implements MouseListener, MouseMotionListener {
    ...
    public void paint(Graphics g) {
        ...
        //g.fillRect(0,300,250,440);
        //g.fillRect(1050,300,250,440);

        //g.setColor(Color.red);

        //g.fillOval(245,305,10,10);
        //g.fillOval(1045,305,10,10);
        ...
        //Vehicule
        int l = (int) (monVehicule.getLargeur());
        int h = monVehicule.getHauteur();

        int x1 = (int) (monVehicule.getX1());
        int y1 = (int) (monVehicule.getY1());
        int x2 = (int) (monVehicule.getX2());
        int y2 = (int) (monVehicule.getY2());

        double alpha = Math.acos((x1 - x2) / l);

        int x3 = (int) (x2 - h * Math.sin(alpha));
        int y3 = (int) (y2 - h * Math.cos(alpha));
        int x4 = (int) (x1 - h * Math.sin(alpha));
        int y4 = (int) (y1 - h * Math.cos(alpha));
